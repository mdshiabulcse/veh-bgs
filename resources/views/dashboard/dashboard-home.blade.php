...
{{--                            <img--}}
{{--                                src="{{asset('admin/')}}/assets/images/svgs/icon-user-male.svg"--}}
{{--                                width="50"--}}
{{--                                height="50"--}}
{{--                                class="mb-3"--}}
{{--                                alt=""--}}
...
{{--                        <div class="text-center">--}}
{{--                            <img--}}
{{--                                src="{{asset('admin/')}}/assets/images/svgs/icon-briefcase.svg"--}}
{{--                                width="50"--}}
{{--                                height="50"--}}
{{--                                class="mb-3"--}}
{{--                                alt=""--}}
...
{{--                        <div class="text-center">--}}
{{--                            <img--}}
{{--                                src="{{asset('admin/')}}/assets/images/svgs/icon-mailbox.svg"--}}
{{--                                width="50"--}}
{{--                                height="50"--}}
{{--                                class="mb-3"--}}
{{--                                alt=""--}}
...
{{--                        <div class="text-center">--}}
{{--                            <img--}}
{{--                                src="{{asset('admin/')}}/assets/images/svgs/icon-favorites.svg"--}}
{{--                                width="50"--}}
{{--                                height="50"--}}
{{--                                class="mb-3"--}}
{{--                                alt=""--}}
...
{{--                        <div class="text-center">--}}
{{--                            <img--}}
{{--                                src="{{asset('admin/')}}/assets/images/svgs/icon-speech-bubble.svg"--}}
{{--                                width="50"--}}
{{--                                height="50"--}}
{{--                                class="mb-3"--}}
{{--                                alt=""--}}
...
{{--                        <div class="text-center">--}}
{{--                            <img--}}
{{--                                src="{{asset('admin/')}}/assets/images/svgs/icon-connect.svg"--}}
{{--                                width="50"--}}
{{--                                height="50"--}}
{{--                                class="mb-3"--}}
{{--                                alt=""--}}
                ...
                <div class="card text-bg-primary border-0 w-100">
                    <div class="card-body pb-0">
                        ...
                        <div class="text-center mt-3">
                            <img
                                src="{{asset('admin/')}}/assets/images/backgrounds/piggy.png"
                                class="img-fluid"
                                alt=""
                            />
                        </div>
