...
<div class="preloader">
    <img
        src="{{asset('/admin/')}}/assets/images/logos/favicon.png"
        alt="loader"
...
<div id="main-wrapper">
    ...
    <aside class="left-sidebar with-vertical">
            ...
            <div class="brand-logo d-flex align-items-center justify-content-between">
                <a href="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/index.html"
                   class="text-nowrap logo-img">
                    ...
                    />
                    <img
                        src="{{asset('/admin/')}}/assets/images/logos/light-logo.svg"
                        class="light-logo"
                        alt="Logo-light"
                    />
                </a>
        ...
        <span class="d-flex">
          <i class="ti ti-chart-donut-3"></i>
                        ...
                        <ul aria-expanded="false" class="collapse first-level">
                            ...
                            <li class="sidebar-item">
                                <a href="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/blog-detail.html"
                                   class="sidebar-link">
                                    <div
                                        class="round-16 d-flex align-items-center justify-content-center"
                                    >
        ...
        <span class="d-flex">
          <i class="ti ti-basket"></i>
                        ...
                        <ul aria-expanded="false" class="collapse first-level">
                            <li class="sidebar-item">
                                <a href="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/eco-shop.html"
                                   class="sidebar-link">
                                    <div
                                        class="round-16 d-flex align-items-center justify-content-center"
                                    >
                            ...
                            <li class="sidebar-item">
                                <a href="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/eco-shop-detail.html"
                                   class="sidebar-link">
                                    <div
                                        class="round-16 d-flex align-items-center justify-content-center"
                                    >
                            ...
                            <li class="sidebar-item">
                                <a href="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/eco-product-list.html"
                                   class="sidebar-link">
                                    <div
                                        class="round-16 d-flex align-items-center justify-content-center"
                                    >
                            ...
                            <li class="sidebar-item">
                                <a href="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/eco-checkout.html"
                                   class="sidebar-link">
                                    <div
                                        class="round-16 d-flex align-items-center justify-content-center"
                                    >
                                ...
                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="position-relative">
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <img
                                                                        src="{{asset('/admin/')}}/assets/images/svgs/icon-dd-chat.svg"
                                                                        alt=""
                                                                        class="img-fluid"
                                                                        width="24"
                                                                        height="24"
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <img
                                                                        src="{{asset('/admin/')}}/assets/images/svgs/icon-dd-invoice.svg"
                                                                        alt=""
                                                                        class="img-fluid"
                                                                        width="24"
                                                                        height="24"
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <img
                                                                        src="{{asset('/admin/')}}/assets/images/svgs/icon-dd-mobile.svg"
                                                                        alt=""
                                                                        class="img-fluid"
                                                                        width="24"
                                                                        height="24"
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <img
                                                                        src="{{asset('/admin/')}}/assets/images/svgs/icon-dd-message-box.svg"
                                                                        alt=""
                                                                        class="img-fluid"
                                                                        width="24"
                                                                        height="24"
                                                    ...
                                                    <div class="col-6">
                                                        <div class="position-relative">
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <img
                                                                        src="{{asset('/admin/')}}/assets/images/svgs/icon-dd-cart.svg"
                                                                        alt=""
                                                                        class="img-fluid"
                                                                        width="24"
                                                                        height="24"
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <img
                                                                        src="{{asset('/admin/')}}/assets/images/svgs/icon-dd-date.svg"
                                                                        alt=""
                                                                        class="img-fluid"
                                                                        width="24"
                                                                        height="24"
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <img
                                                                        src="{{asset('/admin/')}}/assets/images/svgs/icon-dd-lifebuoy.svg"
                                                                        alt=""
                                                                        class="img-fluid"
                                                                        width="24"
                                                                        height="24"
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <img
                                                                        src="{{asset('/admin/')}}/assets/images/svgs/icon-dd-application.svg"
                                                                        alt=""
                                                                        class="img-fluid"
                                                                        width="24"
                                                                        height="24"
                                    ...
                                    <div class="col-4 ms-n4">
                                        <div class="position-relative p-7 border-start h-100">
                                            ...
                                            <ul class="">
                                                <li class="mb-3">
                                                    <a class="fw-semibold bg-hover-primary" href="page-pricing.html"
                                                    >Pricing Page</a
                                                    >
                                                </li>
                                                <li class="mb-3">
                                                ...
                                                <li class="mb-3">
                                                    <a class="fw-semibold bg-hover-primary" href="app-notes.html"
                                                    >Notes App</a
                                                    >
                                                </li>
                                                <li class="mb-3">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            >
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    >
                                        <img
                                            src="{{asset('/admin/')}}/assets/images/svgs/icon-flag-en.svg"
                                            alt=""
                                            width="20px"
                                            height="20px"
                                    ...
                                    >
                                        <div class="message-body">
                                            ...
                                            >
                                                <div class="position-relative">
                                                    <img
                                                        src="{{asset('/admin/')}}/assets/images/svgs/icon-flag-cn.svg"
                                                        alt=""
                                                        width="20px"
                                                        height="20px"
                                                        class="rounded-circle object-fit-cover round-20"
                                            ...
                                            >
                                                <div class="position-relative">
                                                    <img
                                                        src="{{asset('/admin/')}}/assets/images/svgs/icon-flag-fr.svg"
                                                        alt=""
                                                        width="20px"
                                                        height="20px"
                                                        class="rounded-circle object-fit-cover round-20"
                                            ...
                                            >
                                                <div class="position-relative">
                                                    <img
                                                        src="{{asset('/admin/')}}/assets/images/svgs/icon-flag-sa.svg"
                                                        alt=""
                                                        width="20px"
                                                        height="20px"
                                                        class="rounded-circle object-fit-cover round-20"
    ...
    <span class="me-3">
      ...
      >
        <img
            src="{{asset('/admin/')}}/assets/images/svgs/icon-account.svg"
            alt=""
            width="24"
            height="24"
        />
      ...
      >
        <img
            src="{{asset('/admin/')}}/assets/images/svgs/icon-inbox.svg"
            alt=""
            width="24"
            height="24"
        />
      ...
      >
        <img
            src="{{asset('/admin/')}}/assets/images/svgs/icon-tasks.svg"
            alt=""
            width="24"
            height="24"
        />
                ...
                >
                    <nav class="sidebar-nav scroll-sidebar">
                        <div class="offcanvas-header justify-content-between">
                            <img src="{{asset('/admin/')}}/assets/images/logos/favicon.ico" alt="" class="img-fluid"/>
                            <button
                                type="button"
                                class="btn-close"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            <div class="m-n4 unlimited-img">
                                                                <img
                                                                    src="{{asset('/admin/')}}/assets/images/backgrounds/unlimited-bg.png"
                                                                    alt=""
                                                                    class="w-100"
                                                                />
                                                            </div>
        ...
        <aside class="left-sidebar with-horizontal">
            ...
            <div>
                ...
                <nav class="sidebar-nav scroll-sidebar container-fluid">
                    <ul id="sidebarnav">
                        ...
                        <!-- =================== -->
                        <li class="sidebar-item">
                            <a class="sidebar-link has-arrow" href="index-2.html" aria-expanded="false">
          <span>
          ...
          <span>
            <i class="ti ti-notebook"></i>
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <li class="sidebar-item">
                                    <a href="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/landingpage/index.html"
                                       class="sidebar-link">
          ...
          <span class="rounded-3">
            <i class="ti ti-archive"></i>
                    ...
                    <div
                        class="unlimited-access hide-menu bg-primary-subtle position-relative my-7 rounded d-block d-lg-none"
                    >
                        <div class="d-flex">
                            ...
                            <div class="unlimited-access-img">
                                <img
                                    src="{{asset('/admin/')}}/assets/images/backgrounds/rocket.png"
                                    alt=""
                                    class="img-fluid"
                                />
                            </div>
            ...
            <!-- End Sidebar scroll-->
            <div
                class="fixed-profile p-3 bg-light-secondary rounded sidebar-ad mt-3 mx-9 d-block d-lg-none"
            >
                <div class="hstack gap-3 justify-content-between">
                    ...
                    <button
                        class="border-0 bg-transparent text-primary ms-2"
                        tabindex="0"
                        type="button"
                        aria-label="logout"
                        data-bs-toggle="tooltip"
            ...
            <div class="offcanvas-body" data-simplebar style="height: calc(100vh - 80px)">
                ...
                <div class="d-flex flex-row flex-wrap gap-3 customizer-box color-pallete" role="group">
                    ...
                    <label class="btn p-9 btn-outline-primary d-flex align-items-center justify-content-center"
                           ...
                           for="Purple_Theme" data-bs-toggle="tooltip" data-bs-placement="top"
                    ...
                    <label class="btn p-9 btn-outline-primary d-flex align-items-center justify-content-center"
                           ...
                           for="green-theme-layout" data-bs-toggle="tooltip" data-bs-placement="top"
                    ...
                    <label class="btn p-9 btn-outline-primary d-flex align-items-center justify-content-center"
                           ...
                           for="cyan-theme-layout" data-bs-toggle="tooltip" data-bs-placement="top"
                    ...
                    <label class="btn p-9 btn-outline-primary d-flex align-items-center justify-content-center"
                           ...
                           for="orange-theme-layout" data-bs-toggle="tooltip" data-bs-placement="top"
        ...
        <div class="offcanvas-body h-100 px-4 pt-0" data-simplebar>
            <ul class="mb-0">
                <li class="pb-7">
                    <div class="d-flex align-items-center">
                        <img
                            src="{{asset('/admin/')}}/assets/images/products/product-1.jpg"
                            width="95"
                            height="75"
                ...
                <li class="pb-7">
                    <div class="d-flex align-items-center">
                        <img
                            src="{{asset('/admin/')}}/assets/images/products/product-2.jpg"
                            width="95"
                            height="75"
                            class="rounded-1 me-9 flex-shrink-0"
                            alt=""
                ...
                <li class="pb-7">
                    <div class="d-flex align-items-center">
                        <img
                            src="{{asset('/admin/')}}/assets/images/products/product-3.jpg"
                            width="95"
                            height="75"
                            class="rounded-1 me-9 flex-shrink-0"
                            alt=""
